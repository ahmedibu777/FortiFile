...
public class CryptoUtils {
    ...
    public static final int GCM_IV_LENGTH = 12;        // bytes (96 bits recommended)
    ...
    /**
     * Generates a random nonce for GCM.
     */
    ...
    /**
     * Creates a GCM parameter specification from a nonce.
     */
    ...
    /**
     * Initializes a Cipher for AES-GCM in the specified mode.
     */
